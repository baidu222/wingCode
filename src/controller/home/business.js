...
module.exports = class extends think.cmswing.admin {
    ...
    /**
      ...
      async informationAction() {
        ...
        await this.hook('adminUpPic', 'pic1', 0, {$hook_key: 'pic1'});
        await this.hook('adminUpPic', 'pic2', 0, {$hook_key: 'pic2'});
        await this.hook('adminUpPic', 'pic3', 0, {$hook_key: 'pic3'});
        await this.hook('adminUpPic', 'pic4', 0, {$hook_key: 'pic4'});
        await this.hook('adminUpPic', 'pic5', 0, {$hook_key: 'pic5'});
        await this.hook('adminUpPic', 'pic6', 0, {$hook_key: 'pic6'});
        await this.hook('adminUpPic', 'pic7', 0, {$hook_key: 'pic7'});
...
>>>>>>> f59e486d654cb34f0974aaf427336be111f563eb
